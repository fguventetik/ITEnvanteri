        ...
        try:
            ...
            if cihaz_turu == "bilgisayar":
                conn.execute("""
                    ...
                    (bilgisayar_ekipman_kodu, bilgisayar_tip, bilgisayar_marka, bilgisayar_model, cpu, ram, disk, kullanici)
                    VALUES (?, ?, ?, ?, ?, ?, ?, ?)
                """, (
        ...
        try:
            if cihaz_turu == 'bilgisayar':
                cursor.execute('''UPDATE bilgisayarlar SET bilgisayar_ekipman_kodu = ?, bilgisayar_marka = ?, bilgisayar_model = ?, bilgisayar_tip = ?, cpu = ?, ram = ?, disk = ?, kullanici = ? WHERE id = ?''',
                               (form_data.get('bilgisayar_ekipman_kodu'), form_data.get('bilgisayar_marka'), form_data.get('bilgisayar_model'), form_data.get('bilgisayar_tip'),
